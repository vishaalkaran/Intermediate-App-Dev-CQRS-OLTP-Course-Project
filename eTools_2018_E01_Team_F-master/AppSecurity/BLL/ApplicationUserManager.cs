...
namespace AppSecurity.BLL
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        internal const string STR_EMAIL_FORMAT = "{0}@eTools.ca";
        ...
        public int Get_CurrentEmployeeIDFromUserName(string userName)
        {
            using (var context = new ApplicationDbContext())
            {
                return context.Users.Where(x => x.UserName.Equals(userName)).FirstOrDefault().EmployeeID ?? default(int);
            }
        }
        ...
        public void AddUser(UserProfile userinfo)
        {
            ...
            else
            {
                ...
                //Employee existing = sysmgr.Employee_Get((int)userinfo.EmployeeId);
                if (existing == null)
                {
