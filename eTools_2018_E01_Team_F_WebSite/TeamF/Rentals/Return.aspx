                ...
                <asp:ListView ID="RenturnEquipmentListView" runat="server" DataSourceID="ReturnDataSource">
                    <EditItemTemplate>
                        <tr style="background-color: #DCDCDC; color: #000000;">
                            ...
                            <td>
                                <asp:Label Text='<%# Bind("RentalEquipmentID") %>' runat="server" ID="RentalEquipmentIDTextBox" /></td>
                            <td>
                                <asp:Label Text='<%# Bind("Description") %>' runat="server" ID="DescriptionTextBox" /></td>
                            <td>
                                <asp:Label Text='<%# Bind("ModelNumber") %>' runat="server" ID="ModelNumberTextBox" /></td>
                            <td>
                                <asp:Label Text='<%# Bind("SerialNumber") %>' runat="server" ID="SerialNumberTextBox" /></td>
                            <td>
                                <asp:Label Text='<%# Bind("DailyRate") %>' runat="server" ID="DailyRateTextBox" /></td>
                            <td>
                                <asp:TextBox Text='<%# Bind("Condition") %>' runat="server" ID="ConditionTextBox" /></td>
                            <td>
                                <asp:CheckBox Checked='<%# Bind("Available") %>' runat="server" ID="AvailableCheckBox" /></td>
                        </tr>
                    </EditItemTemplate>
                    <EmptyDataTemplate>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: #DCDCDC; color: #000000;">
                            ...
                            <td>
                                <asp:CheckBox Checked='<%# Eval("Available") %>' runat="server" ID="AvailableCheckBox" Enabled="false" /></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table runat="server" width="100%" >
                            <tr runat="server">
                                <td runat="server">
                                    <table runat="server" id="itemPlaceholderContainer" width="100%" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
